...
for (Int_t i = 0; i < nDetetores; i++){
	...
	landouFitPioes->SetLineColor(kGray+2);
	...
	landouFitMuoes->SetLineColor(kRed+2);
	...
	landouFitOutras->SetLineColor(kGreen+2);
...
cs->SaveAs("/home/rosas/Desktop/TrabalhoTECII/Graficos/alinea2/Histograma da Energia depositada por partícula em cada detetor "+root_file("[0-3]")+".png");
